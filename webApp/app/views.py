...
def get_user_data(user):
    ...
    port_list   = session.execute("SELECT tickername, tickerquant, tickervalue FROM db_user_portfolio WHERE userid=" + user)
...
#for(var i=0; i<data.hist_trades.length;i++) {
#    trades += "<tr><td>" + data.hist_trades[i].tickername + "</td><td align='right'>"
#  + data.hist_trades[i].tradequantity + "</td><td>"
#  + data.hist_trades[i].tickerprice + "</td></tr>";
#}
